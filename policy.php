...
?>
    <div class="container over__container">
        <div id="main" class="bg-lighter-dark mx-2 fw-light" style="text-align: justify; color: #8E95A5;">
            <h2 class="text-center">
                Privacy Policy
            </h2>
            <h5>
                This Privacy Policy applies to the Matic group of companies collecting, using, disclosing, processing, and/or transferring out of Singapore, your personal data for one or more of the purposes described in this policy.
            </h5>
            <p>
                Matic respects your privacy. This document outlines our privacy policy for the Matic group of companies.
            </p>
            <h6>
            ...
            <ul>
            <li>
                This Privacy Policy covers our treatment of personal data that we may collect when you interact with us, submit information to us, access and/or use our products or services (such as but not limited to online and mobile websites, applications, and other digital services) (collectively, the "Matic Services").
            </li>
            <li>
                This policy does not apply to the practices of companies that we do not own or control, or to people that we do not employ or manage. Matic Services may contain links to other websites, applications and other services. Please note that we are not responsible for the privacy practices of such other websites, applications and other services and we advise you to read the privacy statements of such websites, applications and other services you visit which collects personal information.
            </li>
            </ul>
            <h6>
            ...
            <p>
                In the event that you wish for us to discontinue the collection, use, disclosure and/or processing of your personal data for any of the above purposes, you may also write in to us at 
                <a class="d-inline " href="mailto:nhutb1910428@student.ctu.edu.vn">nhutb1910428@student.ctu.edu.vn</a> or <a class="d-inline " href="mailto:nhanb1910420@student.ctu.edu.vn">nhanb1910420@student.ctu.edu.vn</a>
            </p>
            <p>
            ...
            <p>
                You may update your personal information at any time by accessing your account(s) with us. You may also update or request for the deletion of your personal information by writing to us at <a class="d-inline " href="mailto:nhutb1910428@student.ctu.edu.vn">nhutb1910428@student.ctu.edu.vn</a> or <a class="d-inline " href="mailto:nhanb1910420@student.ctu.edu.vn">nhanb1910420@student.ctu.edu.vn</a>
            </p>
            <h6>
            ...
            <p>
                (a)        Matic and/or Matic's group companies collecting, using, disclosing and/or processing your personal data for the purposes and situations as described above;
            </p>
            <p>
                (b)        Matic and/or Matic's group companies  transferring your personal data out of Singapore to Matic's and/or Matic's group companies' third party service providers or agents for the purposes and situations as described above.
            </p>
            <h6>
                How is your data protected?
            </h6>
            <p>
                We will take reasonable steps to ensure that personal data are protected from unauthorized access and other similar risks. Access to your account(s) is password protected. Thus, no other party, including Matic employees, can change the information. However, you must remember to log off from your account and close the browser window after use so that no unauthorized party can have access. You are responsible for the safe-keeping of your password. You must not, at any time, disclose your password to any third party. We will not be responsible and you agree that you will not hold us responsible for any losses or damage incurred by you whatsoever caused by your non-compliance to any of the foregoing. All information gathered by Matic is stored in systems that may only be accessed by authorised Matic staff using assigned user ids and passwords. In certain areas, Matic uses industry-standard SSL-encryption to protect data transmissions.
            </p>
            <h6>
                Changes to this Privacy Policy
            </h6>
            <p>
                Matic may amend this policy from time to time. If we make any substantial changes in the way we use your personal information, we will notify you by posting an announcement on our platforms. You agree that such posting will constitute sufficient and adequate notice to you of the changes. You agree that your continued use of our products and services after such amendment will constitute your acceptance of and agreement to be bound by the modified policy.
            </p>
            <h6>
                Use of cookies, web beacons and other user and ad-targeting technologies
            </h6>
            <p>
                When you access, use and/or interact with the Matic Services, we or our authorized service providers may use "cookies", “web beacons” and other tracking technologies where small data files are sent to your browser, application or device to store and track information about you. The cookies, web beacons and other tracking technologies are used to track information such as the number of users and their frequency of use, online behavioral data, profiles of users and their preferred sites. They enable our own system to recognise you when you visit us again, enhance your web-viewing experience and allow for more effective online targeted advertising. You may accept or decline cookies by modifying the settings in your browser, application or device, if the browser, application or device so permits. However, note that you may not be able to use all interactive features on the Matic Services if cookies have been disabled completely. While this cookie can tell us when you interact with the Matic Services and which pages you visit, it cannot access other data including from your computer or storage device and it does not contain information intended to identify you personally.
            </p>    
            <p>
                Matic does not utilise persistent cookies to track, or target advertisements to, persons who are resident in the European Union.
            </p>
            <h6>
                Release
            </h6>
