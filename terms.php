...
?>
    <div class="container over__container">
        <div id="main" class="bg-lighter-dark mx-2 fw-light" style="text-align: justify; color: #8E95A5;">
            ...
            <h5>Upload</h5>
            <h6>You represent, warrant and agree that:</h6>
            <ol>
                <li>
                    You are the owner of all the rights in the content
                </li>
                <li>
                    No content submitted by you will:
                    <ul>
                        <li>
                            Be defamatory, abusive or offensive; infringe the copyright, moral right, performing rights, rights of privacy, trade mark or other proprietary right of? any third party; constitute a misuse of any confidential information of a third party
                        </li>
                        <li>
